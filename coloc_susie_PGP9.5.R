# coloc.susie PGP9.5 (UCHL1) — DBP, chr14:94510949-94910949
...
chr <- "14"; cis_start <- 94510949; cis_end <- 94910949
outcome_id <- "ebi-a-GCST90025968"; outcome_N <- 422713; oc_name <- "DBP"
decode_paths <- c("D:/多组学MR数据/pqtl/Proteomics_SMP_PC0_5019_16_UCHL1_PGP9_5_10032022.txt.gz",
                  "data/pqtl/decode/Proteomics_SMP_PC0_5019_16_UCHL1_PGP9_5_10032022.txt.gz")
vcf_base <- "D:/多组学MR数据/ld_reference"
vcf_chr  <- file.path(vcf_base, "ALL.chr14.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.vcf.gz")
...
write.csv(data.frame(
  protein="PGP9.5 (UCHL1)", outcome=oc_name, n_abf=n, n_susie=ns,
  ...
  "results/tables/coloc_susie_PGP9.5_vcf.csv", row.names=FALSE)
cat("[Done]\n")
