# coloc.susie NovH (CCN3) — DBP, chr8:120235705-120635705
...
chr <- "8"; cis_start <- 120235705; cis_end <- 120635705
outcome_id <- "ebi-a-GCST90025968"; outcome_N <- 422713; oc_name <- "DBP"
decode_paths <- c("D:/多组学MR数据/pqtl/Proteomics_SMP_PC0_2737_22_NOV_NovH_10032022.txt.gz",
                  "data/pqtl/decode/Proteomics_SMP_PC0_2737_22_NOV_NovH_10032022.txt.gz")
vcf_base <- "D:/多组学MR数据/ld_reference"
vcf_chr  <- file.path(vcf_base, "ALL.chr8.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.vcf.gz")
...
write.csv(data.frame(
  protein="NovH (CCN3)", outcome=oc_name, n_abf=n, n_susie=ns,
  ...
  "results/tables/coloc_susie_NovH_vcf.csv", row.names=FALSE)
cat("[Done]\n")
