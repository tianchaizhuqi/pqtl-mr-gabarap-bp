# coloc.susie Lysozyme — HTN, chr12:69535492-69935492
...
chr <- "12"; cis_start <- 69535492; cis_end <- 69935492
outcome_id <- "ukb-b-12493"; outcome_N <- 463010; oc_name <- "HTN"
decode_paths <- c("D:/多组学MR数据/pqtl/Proteomics_SMP_PC0_4920_10_LYZ_Lysozyme_10032022.txt.gz",
                  "data/pqtl/decode/Proteomics_SMP_PC0_4920_10_LYZ_Lysozyme_10032022.txt.gz")
vcf_base <- "D:/多组学MR数据/ld_reference"
vcf_chr  <- file.path(vcf_base, "ALL.chr12.phase3_shapeit2_mvncall_integrated_v5b.20130502.genotypes.vcf.gz")
...
write.csv(data.frame(
  protein="Lysozyme", outcome=oc_name, n_abf=n, n_susie=ns,
  ...
  "results/tables/coloc_susie_Lysozyme_vcf.csv", row.names=FALSE)
cat("[Done]\n")
